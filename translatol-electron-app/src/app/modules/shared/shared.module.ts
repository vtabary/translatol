...
import { NOTIFICATION_SERVICE, TranslatolSharedModule } from 'translatol-shared-module';
...
@NgModule({
  ...
  providers: [{ provide: NOTIFICATION_SERVICE, useExisting: NotificationService }],
})
