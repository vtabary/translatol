...
export class TranslationsComponent {
  ...
  public onSave() {
    this.fileService
      .saveXLIFF(this.filePath, this.translationRoot)
      .pipe(
        switchMap(() =>
  ...
  private filterByText(
    ...
    return translations.filter((translation) => {
      return (
        translation.name.indexOf(filter) >= 0 ||
