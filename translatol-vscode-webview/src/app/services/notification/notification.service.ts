...
export class NotificationService implements NotificationServiceInterface {
  ...
  public showInformation(message: string): void {
    this.postMessageService.sendMessage({ type: 'notification', level: 'info', message });
  }
  public showWarning(message: string): void {
    this.postMessageService.sendMessage({ type: 'notification', level: 'warning', message });
  }
  public showError(message: string): void {
    this.postMessageService.sendMessage({ type: 'notification', level: 'error', message });
  }
}
